...
The purpose of the infrastructure layer is to fetch entities from the persistence, in our case mostly the database itself. For most of our cases we can just use the `repository from the graphql-storefront module <https://github.com/OXID-eSales/graphql-storefront-module/blob/b-7.3.x/src/Shared/Infrastructure/Repository.php>`_.
